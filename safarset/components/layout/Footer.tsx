        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-[#E85D26] rounded-lg flex items-center justify-center font-bold text-sm">S</div>
              <span className="text-xl font-bold">Safar<span className="text-[#E85D26]">Set</span></span>
            </div>
            <p className="text-blue-200 text-sm leading-relaxed mb-4">Plan Karo. Safar Set Karo.<br />India's smartest AI travel planning platform.</p>
